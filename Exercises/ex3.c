...
void main()
{
    int userChoice = 0, amountOfOnes, amountOfTwos, amountOfFives, amountOfTens, price = 0, sum, change;
    int waterStock, orangeStock, appleStock, spriteStock, colaStock;
    waterStock = orangeStock = appleStock = spriteStock = colaStock = 10;
    while (userChoice != 6)
    {
